  ...
  apps: [
    {
      ...
      env: {
        ...
        VERCEL_DEPLOY_PLUGIN_HOOK: env.VERCEL_DEPLOY_PLUGIN_HOOK1,
        VERCEL_DEPLOY_PLUGIN_API_TOKEN: env.VERCEL_DEPLOY_PLUGIN_API_TOKEN1,
        VERCEL_DEPLOY_PLUGIN_APP_FILTER: env.VERCEL_DEPLOY_PLUGIN_APP_FILTER1,
        VERCEL_DEPLOY_PLUGIN_TEAM_FILTER: env.VERCEL_DEPLOY_PLUGIN_TEAM_FILTER1,
      }
    },
    {
      name: env.NAME2,
      ...
      env: {
        ...
        VERCEL_DEPLOY_PLUGIN_HOOK: env.VERCEL_DEPLOY_PLUGIN_HOOK2,
        VERCEL_DEPLOY_PLUGIN_API_TOKEN: env.VERCEL_DEPLOY_PLUGIN_API_TOKEN2,
        VERCEL_DEPLOY_PLUGIN_APP_FILTER: env.VERCEL_DEPLOY_PLUGIN_APP_FILTER2,
        VERCEL_DEPLOY_PLUGIN_TEAM_FILTER: env.VERCEL_DEPLOY_PLUGIN_TEAM_FILTER2,
      }
    },
    {
      name: env.NAME3,
      ...
      env: {
        ...
        VERCEL_DEPLOY_PLUGIN_HOOK: env.VERCEL_DEPLOY_PLUGIN_HOOK3,
        VERCEL_DEPLOY_PLUGIN_API_TOKEN: env.VERCEL_DEPLOY_PLUGIN_API_TOKEN3,
        VERCEL_DEPLOY_PLUGIN_APP_FILTER: env.VERCEL_DEPLOY_PLUGIN_APP_FILTER3,
        VERCEL_DEPLOY_PLUGIN_TEAM_FILTER: env.VERCEL_DEPLOY_PLUGIN_TEAM_FILTER3,
      }
    },
    {
      name: env.NAME4,
      ...
      env: {
        ...
        VERCEL_DEPLOY_PLUGIN_HOOK: env.VERCEL_DEPLOY_PLUGIN_HOOK4,
        VERCEL_DEPLOY_PLUGIN_API_TOKEN: env.VERCEL_DEPLOY_PLUGIN_API_TOKEN4,
        VERCEL_DEPLOY_PLUGIN_APP_FILTER: env.VERCEL_DEPLOY_PLUGIN_APP_FILTER4,
        VERCEL_DEPLOY_PLUGIN_TEAM_FILTER: env.VERCEL_DEPLOY_PLUGIN_TEAM_FILTER4,
      }
    },
  ]
});